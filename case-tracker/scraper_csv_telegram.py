...
name = "shell_v_odette_"

# --- CONFIGURATION ---
BQ_PROJECT_ID = os.environ.get("BQ_PROJECT_ID")
BQ_DATASET = os.environ.get("BQ_DATASET")
BQ_TABLE = f"{BQ_DATASET}.{name}telegram"
BQ_LOCATION = "EU"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file", default="scrape_results/investigative_results_2025-12-15.csv", help="Path to the Telegram CSV file")
