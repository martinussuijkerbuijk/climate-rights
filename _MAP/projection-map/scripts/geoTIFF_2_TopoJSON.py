...
if __name__ == '__main__':
    ...
    input_file = 'global_surface_temp_20190701.tif' 
    
    # An intermediate file that will be created and then can be deleted.
    intermediate_geojson = 'D:\_POSTDOC\_CR\github\climate-rights\_MAP\projection-map\public\qgis_export.geojson'
    
    # The final, optimized TopoJSON file for your web app.
    output_file = 'surface_temp_contours_qgis.topojson'
